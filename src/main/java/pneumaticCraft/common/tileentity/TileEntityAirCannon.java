...
public class TileEntityAirCannon extends TileEntityPneumaticBase implements ISidedInventory, IInventory,
    ...
    private Entity getCloseEntityIfUpgraded(){
        ...
        if(entityUpgrades > 0) {
            ...
            List<EntityLivingBase> entities = worldObj.getEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.getBoundingBox(xCoord - entityUpgrades, yCoord - entityUpgrades, zCoord - entityUpgrades, xCoord + 1 + entityUpgrades, yCoord + 1 + entityUpgrades, zCoord + 1 + entityUpgrades));
